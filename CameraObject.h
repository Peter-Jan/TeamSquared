...
=======
    double grav = 0,fric=0.05,maxVel = 0.75, stopThresh = 0.02;
    double horzVel, velRatio;
    int roomSize = 0;
    ...
    double jumpVel;
    double vertVel, camHeight, pWid, zoom, viewRadius, sensitivity, fov, nearZ, farZ, coneAngle;
    std::vector<double> forwardVector = { 0,0,0 };
    std::vector<double> pos = { 0,0,0 };
    std::vector<int> gridLocation = { 0,0,0 };
